...
values ('assetPacketManage', 'viewProcess', '选聘流程查看', null, null, null, '1', null, null, null, null);
...
values ('assetPacketManage', 'viewProcess', 'admin', 'admin', 0, 0, 0, '1', '1');

insert into tsys_user_right (TRANS_CODE, SUB_TRANS_CODE, USER_ID, CREATE_BY, CREATE_DATE, BEGIN_DATE, END_DATE, RIGHT_FLAG, RIGHT_ENABLE)
values ('assetPacketManage', 'viewProcess', 'admin', 'admin', 0, 0, 0, '2', '1');
...
values ('assetPacketManage', 'viewProcess', 'admin', 'admin', 0, 0, 0, '1', null);

insert into tsys_role_right (TRANS_CODE, SUB_TRANS_CODE, ROLE_CODE, CREATE_BY, CREATE_DATE, BEGIN_DATE, END_DATE, RIGHT_FLAG, RIGHT_ENABLE)
values ('assetPacketManage', 'viewProcess', 'admin', 'admin', 0, 0, 0, '2', null);
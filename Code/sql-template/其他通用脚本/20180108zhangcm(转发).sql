...
values ('flowTaskOwner', 'processNotice', '转发', null, null, null, '1', '转发', null, null, null);
...
values ('flowTaskOwner', 'processNotice', 'admin', 'admin', 0, 0, 0, '1', '1');

insert into tsys_user_right (TRANS_CODE, SUB_TRANS_CODE, USER_ID, CREATE_BY, CREATE_DATE, BEGIN_DATE, END_DATE, RIGHT_FLAG, RIGHT_ENABLE)
values ('flowTaskOwner', 'processNotice', 'admin', 'admin', 0, 0, 0, '2', '1');

...
values ('myasset', 'startreceivepayment', '发起费用回款流程', null, null, null, '1', null, null, null, null);
...
values ('myasset', 'startreceivepayment', 'admin', 'admin', 0, 0, 0, '1', '1');

insert into tsys_user_right (TRANS_CODE, SUB_TRANS_CODE, USER_ID, CREATE_BY, CREATE_DATE, BEGIN_DATE, END_DATE, RIGHT_FLAG, RIGHT_ENABLE)
values ('myasset', 'startreceivepayment', 'admin', 'admin', 0, 0, 0, '2', '1');
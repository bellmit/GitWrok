--[201802050341]20180316shiph22854(风险预警信息，风险预警反馈自动提醒)--start--
declare 
v_clob_afn clob;
...
v_clob_afn :='select distinct t.l_id,
       ...
       || CHR(38) ||''warningInfoId=''||t.L_ruleid
  ...
  from tafter_investment_notice t where t.c_status = 0 and t.c_type=''2'' and to_char(t.d_noticedate,''yyyymmdd'') = to_char(sysdate,''yyyymmdd'')';

declare
begin
if not fc_IsDataExists('select count(*) from trepay_confirm_config t where t.c_project_type = ''90'' and t.c_repay_type = ''22080''') and not fc_IsDataExists('select count(*) from trepay_confirm_config t where t.l_id= ''62''')then

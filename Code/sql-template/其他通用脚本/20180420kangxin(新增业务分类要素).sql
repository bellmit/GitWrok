...
declare
begin
if not fc_isexistsprojectfactorinfo('tproject_info_busiclassification') then
...
values ('tproject_info_busiclassification', '业务分类', '1', '基本信息', '11', '基本信息', null, 'tproject_info', 'busiclassification', '0', null, '6', 'PM_BUSINESS_TYPE', 5, 200, 18, 1, 1, 9, '1', '0', null, '1', '1', '1', 'tproject_info_busiclassification', null, '0', null, null, null, null);
end if;
end;
/
